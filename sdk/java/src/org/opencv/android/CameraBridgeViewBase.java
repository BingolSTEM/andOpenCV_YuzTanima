        ...
        if (bmpValid && mCacheBitmap != null) {
            ...
            if (canvas != null) {
                ...
                if (BuildConfig.DEBUG)
                    ...
                    matris.preTranslate((canvas.getWidth()-mCacheBitmap.getWidth())/2,(canvas.getHeight()-mCacheBitmap.getHeight())/2);
                    matris.postRotate(270f,(canvas.getWidth())/2,(canvas.getHeight())/2);
                    float scale=(float) canvas.getWidth() / (float) (mCacheBitmap.getHeight());
                    matris.postScale(scale,scale,canvas.getWidth()/2,canvas.getHeight()/2);
                    canvas.drawBitmap(mCacheBitmap,matris,new Paint());




            /* Döndürme ve Ölçekleme 1. Yöntem
            // Döndürme Kodu....
